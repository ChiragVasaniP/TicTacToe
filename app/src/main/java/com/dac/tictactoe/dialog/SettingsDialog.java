package com.dac.tictactoe.dialog;
...
import android.widget.ImageView;import com.dac.tictactoe.util.PrefManager;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        ivShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sAux = sAux + "https://play.google.com/store/apps/details?id=com.dac.tictactoe \n";
